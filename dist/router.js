...
//CANDIDATE---------------------------------------------------------------------
router.post("/create-candidate", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield candidateController.candidateCreateController(req, res);
}));
router.patch("/update-candidate/:id", auth_middleware_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield candidateController.candidateUpdateController(req, res);
}));
router.delete("/delete-candidate/:id", auth_middleware_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield candidateController.candidateDeleteController(req, res);
}));
router.get("/list-all-candidates", auth_middleware_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield candidateController.candidateListAllController(req, res);
}));
router.get("/list-candidate/:id", auth_middleware_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
